...
# Task Endpoints
# Todo: Add a new endpoint to get all tasks for a user
# Todo: Add a new endpoint to create a task for a user
# Todo: Add a new endpoint to update a task for a user
# Todo: Add a new endpoint to delete a task for a user
